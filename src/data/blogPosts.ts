...
export const blogPosts = [
  ...
  },
  {
    ...
    title: "SAF-T: що це таке і як він працює в Україні",
    cardTitle: "SAF-T: що це таке, структура, вимоги і підготовка",
    readingTime: "15 хв читання",
    excerpt: "SAF-T (Standard Audit File for Tax) — міжнародний стандарт передачі облікових даних податковому органу, адаптований в Україні як SAF-T UA. У 2026 році вимога подавати його поширюється на дедалі ширше коло платників.",
    date: "13 січня 2026",
    isoDate: "2026-01-13",
    service: ["saft"],
  ...
  {
    category: "Аудит та звітність",
    title: "Обов'язковий аудит середніх підприємств у 2026 році: критерії, строки та вимоги",
    cardTitle: "Аудит середніх підприємств у 2026 році",
    readingTime: "12 хв читання",
    excerpt: "Середнє підприємство — категорія, де найчастіше помиляються з визначенням статусу. LUCAS пояснює критерії, чому середні підприємства не є ПСІ, і що це означає для вибору аудитора та строків.",
    date: "12 лютого 2026",
    isoDate: "2026-02-12",
    service: ["audit"],
  ...
  {
    category: "Трансфертне ціноутворення",
    title: "Трансфертне ціноутворення 2026: критерії, вимоги, хто подає звіт і хто готує документацію",
    cardTitle: "Трансфертне ціноутворення 2026: повний огляд",
    readingTime: "22 хв читання",
    excerpt: "Критерії контрольованих операцій у 2026 році, пороги 150 млн і 10 млн грн, хто подає звіт про КО, хто готує документацію з ТЦУ, строки та найчастіші ризики.",
    date: "5 серпня 2026",
    isoDate: "2026-08-05",
    service: ["transfer-pricing"],
  ...
  {
    category: "Аудит та звітність зі сталого розвитку",
    title: "Аудит звітності зі сталого розвитку в Україні: що зміниться для бізнесу",
    cardTitle: "Аудит звітності зі сталого розвитку: що зміниться",
    readingTime: "14 хв читання",
    excerpt: "Україна рухається до європейських правил звітності зі сталого розвитку та незалежного підтвердження такої звітності. LUCAS пояснює, кого це може стосуватися, що саме перевірятимуть аудитори і чому ESG-дані потрібно готувати заздалегідь.",
    date: "7 вересня 2026",
    isoDate: "2026-09-07",
    service: ["audit"],
